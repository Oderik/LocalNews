...
public class NewsListActivity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.news_detail_container) != null) {
            ...
            // res/values-w720dp). If this view is present, then the
    ...
    public void onItemSelected(News news) {
        if (mTwoPane) {
            ...
            arguments.putSerializable(NewsDetailFragment.ARG_NEWS, news);
            ...
            detailIntent.putExtra(NewsDetailFragment.ARG_NEWS, news);
